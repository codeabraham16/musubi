...
| A123 | **Los 346 sabotajes declarados que nadie corrió nunca: el árbol promete 384 y sólo 38 tienen veredicto** | Sale de cerrar A120, y estaba dicho adentro de esa fila sin número propio: el repo declara **384 «Sabotaje que la hace fallar» en 89 archivos de prueba** (contado el 2026-09-10 en `f9be15a`; A107 los había contado en 383/88), y la única auditoría que les dio veredicto —A107— cubrió 37, más el de A120 que se cerró después: **38, el 9,9 %**. De los otros **346 no hay lista ejecutable**: `deploy/pruebas/sabotaje.sh` existe y sirve para correr UNO, pero nada recorre los declarados ni lleva la cuenta de cuáles se verificaron. **Por qué importa el número y no la anécdota**: de los 37 auditados, A107 encontró cuatro que su propio sabotaje declarado NO rompía, y A120 encontró dos más — o sea que la tasa medida de sabotajes que mienten no es cero, y se está aplicando a menos de la décima parte del árbol. Un «sabotaje que la hace fallar» sin correr es exactamente la clase de promesa que este registro persigue: no falla, tranquiliza. **Se cierra con una lista ejecutable y su cuenta**, no con otra auditoría a mano. | sin asignar |

...
>
> **Cabos abiertos hoy: 31.** Es la cuenta de las filas de la tabla 1, y no se escribe a mano:
...
6. **El número es la identidad: uno solo por cosa, y para siempre.** Un número nuevo va por encima
   del máximo en uso (hoy **A127** y **B21**) y NO se recicla uno libre: `A6`-`A9`, `A15` y `A16`

...
// dibuje muerto. Hasta A131 (tema T10) ninguna prueba contaba lo que un latido entrega, y este
// número al doble pasaba en verde (C4-m8); lo cuenta TestUnLatidoEntregaLaTandaEnteraYNiUnComandoMas.

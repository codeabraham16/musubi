...
type McpServer struct {
	...
	// techoServiciosExport es cuántos servicios POR PROYECTO salen a métricas en cada export
	// (scrape y empuje). 0 = sin techo. Lo fija ConfigurarFlota desde config.FleetConfig; el
	// default vive allá, no acá, por lo mismo que sondaIntervalo.
	techoServiciosExport int

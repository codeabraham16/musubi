...
| **Skills** | `musubi_detect_stack` · `musubi_search_skills` · `musubi_list_skills` · `musubi_promote_skill` · `musubi_install_skill` · `musubi_save_skill` · `musubi_resolve_skills` · `musubi_log_skill_decision` · `musubi_discover_skills` (marketplace) · `musubi_author_skill` |

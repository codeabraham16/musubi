...
flowchart LR
    ...
    subgraph M["Musubi · daemon Go"]
        direction TB
        RPC["JSON-RPC 2.0 / stdio<br/>81 herramientas MCP"]
...
El servidor expone **81 herramientas**, agrupadas por dominio:
...
internal/
  ...
  mcp/             # servidor JSON-RPC 2.0 + las 81 herramientas MCP

	...
	return []skills.Skill{
		...
		},
		{
			...
			Rules: "Antes de dar por bueno un cambio de riesgo (o en la fase verify de un flujo SDD), sometelo a un DEBATE adversarial con veredicto determinista en vez de una sola lectura complaciente:\n" +
				...
				"4. Abrí el debate con musubi_debate action=open topic=<el cambio a juzgar> rounds=<las del panel del paso 3> quorum=<el del panel>. Guardá el debate_id. (musubi_debate estructura las rondas y CUENTA los votos sin sesgo; la inteligencia de refutar es tuya.)\n" +

	...
	return []skills.Skill{
		...
		},
		{
			...
			Rules: "Antes de dar por bueno un cambio de riesgo (o en la fase verify de un flujo SDD), sometelo a un DEBATE adversarial con veredicto determinista en vez de una sola lectura complaciente:\n" +
				...
				"7. Registrá lo aprendido con musubi_save_observation (topic_key 'review/<change>'); el debate ya conserva las posturas y el veredicto. Si el hallazgo contradice una memoria previa, resolvé la relación con musubi_judge.\n",
		},
		{

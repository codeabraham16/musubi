...
`)+`
`+m);let y=w+p+o,A=w+m+a,I=Xh(s,s.VERTEX_SHADER,y),C=Xh(s,s.FRAGMENT_SHADER,A);s.attachShader(_,I),s.attachShader(_,C),e.index0AttributeName!==void 0?s.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(_,0,"position"),s.linkProgram(_);function E(S){if(n.debug.checkShaderErrors){let O=s.getProgramInfoLog(_).trim(),W=s.getShaderInfoLog(I).trim(),q=s.getShaderInfoLog(C).trim(),et=!0,F=!0;if(s.getProgramParameter(_,s.LINK_STATUS)===!1)if(et=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,_,I,C);else{let it=qh(s,I,"vertex"),Z=qh(s,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(_,s.VALIDATE_STATUS)+`
